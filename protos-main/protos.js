 ...
 * @property {number} EncryptKey=1 EncryptKey value
 */
export const Type = $root.Type = (() => {
    const valuesById = {}, values = Object.create(valuesById);
    values[valuesById[0] = "Request"] = 0;
    values[valuesById[1] = "EncryptKey"] = 1;
    return values;
})();

export const SecurityMessage = $root.SecurityMessage = (() => {

    /**
     * Properties of a SecurityMessage.
     * @exports ISecurityMessage
     * @interface ISecurityMessage
     * @property {Type|null} [type] SecurityMessage type
     * @property {Array.<string>|null} [publicKey] SecurityMessage publicKey
     * @property {Array.<string>|null} [signature] SecurityMessage signature
     * @property {Array.<string>|null} [encryptedPassword] SecurityMessage encryptedPassword
     * @property {Array.<string>|null} [signaturePublicKey] SecurityMessage signaturePublicKey
     */

    /**
     * Constructs a new SecurityMessage.
     * @exports SecurityMessage
     * @classdesc Represents a SecurityMessage.
     * @implements ISecurityMessage
     * @constructor
     * @param {ISecurityMessage=} [properties] Properties to set
     */
    function SecurityMessage(properties) {
        this.publicKey = [];
        this.signature = [];
     ...
     * @instance
     */
    SecurityMessage.prototype.type = 0;

    /**
     * SecurityMessage publicKey.
     * @member {Array.<string>} publicKey
     * @memberof SecurityMessage
     * @instance
     */
    SecurityMessage.prototype.publicKey = $util.emptyArray;
     ...
     * @instance
     */
    SecurityMessage.prototype.signature = $util.emptyArray;

    /**
     * SecurityMessage encryptedPassword.
     * @member {Array.<string>} encryptedPassword
     * @memberof SecurityMessage
     * @instance
     */
    SecurityMessage.prototype.encryptedPassword = $util.emptyArray;

    /**
     * SecurityMessage signaturePublicKey.
     * @member {Array.<string>} signaturePublicKey
     * @memberof SecurityMessage
     * @instance
     */
    SecurityMessage.prototype.signaturePublicKey = $util.emptyArray;

    /**
     * Creates a new SecurityMessage instance using the specified properties.
     * @function create
     * @memberof SecurityMessage
     * @static
     * @param {ISecurityMessage=} [properties] Properties to set
     * @returns {SecurityMessage} SecurityMessage instance
     */
    SecurityMessage.create = function create(properties) {
        return new SecurityMessage(properties);
    };

    /**
     * Encodes the specified SecurityMessage message. Does not implicitly {@link SecurityMessage.verify|verify} messages.
     * @function encode
     * @memberof SecurityMessage
     * @static
     * @param {ISecurityMessage} message SecurityMessage message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    SecurityMessage.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.type != null && Object.hasOwnProperty.call(message, "type"))
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.type);
        if (message.publicKey != null && message.publicKey.length)
            for (let i = 0; i < message.publicKey.length; ++i)
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.publicKey[i]);
        if (message.signature != null && message.signature.length)
            for (let i = 0; i < message.signature.length; ++i)
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.signature[i]);
        if (message.encryptedPassword != null && message.encryptedPassword.length)
            for (let i = 0; i < message.encryptedPassword.length; ++i)
                writer.uint32(/* id 4, wireType 2 =*/34).string(message.encryptedPassword[i]);
        if (message.signaturePublicKey != null && message.signaturePublicKey.length)
            for (let i = 0; i < message.signaturePublicKey.length; ++i)
                writer.uint32(/* id 5, wireType 2 =*/42).string(message.signaturePublicKey[i]);
        return writer;
    };

    /**
     * Encodes the specified SecurityMessage message, length delimited. Does not implicitly {@link SecurityMessage.verify|verify} messages.
     * @function encodeDelimited
     * @memberof SecurityMessage
     * @static
     * @param {ISecurityMessage} message SecurityMessage message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    SecurityMessage.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a SecurityMessage message from the specified reader or buffer.
     * @function decode
     * @memberof SecurityMessage
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {SecurityMessage} SecurityMessage
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SecurityMessage.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SecurityMessage();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    /**
     * Decodes a SecurityMessage message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof SecurityMessage
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SecurityMessage.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a SecurityMessage message.
     * @function verify
     * @memberof SecurityMessage
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    SecurityMessage.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.type != null && message.hasOwnProperty("type"))
            switch (message.type) {
        ...
        if (message.publicKey != null && message.hasOwnProperty("publicKey")) {
            if (!Array.isArray(message.publicKey))
                return "publicKey: array expected";
            for (let i = 0; i < message.publicKey.length; ++i)
                if (!$util.isString(message.publicKey[i]))
        ...
        if (message.signature != null && message.hasOwnProperty("signature")) {
            ...
            for (let i = 0; i < message.signature.length; ++i)
                if (!$util.isString(message.signature[i]))
                    return "signature: string[] expected";
        }
        if (message.encryptedPassword != null && message.hasOwnProperty("encryptedPassword")) {
            if (!Array.isArray(message.encryptedPassword))
                return "encryptedPassword: array expected";
            for (let i = 0; i < message.encryptedPassword.length; ++i)
                if (!$util.isString(message.encryptedPassword[i]))
                    return "encryptedPassword: string[] expected";
        }
        if (message.signaturePublicKey != null && message.hasOwnProperty("signaturePublicKey")) {
            if (!Array.isArray(message.signaturePublicKey))
                return "signaturePublicKey: array expected";
            for (let i = 0; i < message.signaturePublicKey.length; ++i)
                if (!$util.isString(message.signaturePublicKey[i]))
                    return "signaturePublicKey: string[] expected";
        }
        return null;
    };

    /**
     * Creates a SecurityMessage message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof SecurityMessage
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {SecurityMessage} SecurityMessage
     */
    SecurityMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.SecurityMessage)
            return object;
        ...
        if (object.publicKey) {
            if (!Array.isArray(object.publicKey))
                throw TypeError(".SecurityMessage.publicKey: array expected");
            message.publicKey = [];
            for (let i = 0; i < object.publicKey.length; ++i)
                message.publicKey[i] = String(object.publicKey[i]);
        }
        if (object.signature) {
            if (!Array.isArray(object.signature))
                throw TypeError(".SecurityMessage.signature: array expected");
            message.signature = [];
            for (let i = 0; i < object.signature.length; ++i)
                message.signature[i] = String(object.signature[i]);
        }
        if (object.encryptedPassword) {
            if (!Array.isArray(object.encryptedPassword))
                throw TypeError(".SecurityMessage.encryptedPassword: array expected");
            message.encryptedPassword = [];
            for (let i = 0; i < object.encryptedPassword.length; ++i)
                message.encryptedPassword[i] = String(object.encryptedPassword[i]);
        }
        if (object.signaturePublicKey) {
            if (!Array.isArray(object.signaturePublicKey))
                throw TypeError(".SecurityMessage.signaturePublicKey: array expected");
            message.signaturePublicKey = [];
            for (let i = 0; i < object.signaturePublicKey.length; ++i)
                message.signaturePublicKey[i] = String(object.signaturePublicKey[i]);
        }
        return message;
    };

    /**
     * Creates a plain object from a SecurityMessage message. Also converts values to other types if specified.
     * @function toObject
     * @memberof SecurityMessage
     * @static
     * @param {SecurityMessage} message SecurityMessage
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    SecurityMessage.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.arrays || options.defaults) {
        ...
        if (message.publicKey && message.publicKey.length) {
            ...
            for (let j = 0; j < message.publicKey.length; ++j)
                object.publicKey[j] = message.publicKey[j];
        }
        if (message.signature && message.signature.length) {
            object.signature = [];
            for (let j = 0; j < message.signature.length; ++j)
                object.signature[j] = message.signature[j];
        }
        if (message.encryptedPassword && message.encryptedPassword.length) {
            object.encryptedPassword = [];
            for (let j = 0; j < message.encryptedPassword.length; ++j)
                object.encryptedPassword[j] = message.encryptedPassword[j];
        }
        if (message.signaturePublicKey && message.signaturePublicKey.length) {
            object.signaturePublicKey = [];
            for (let j = 0; j < message.signaturePublicKey.length; ++j)
                object.signaturePublicKey[j] = message.signaturePublicKey[j];
        }
        return object;
    };

    /**
     * Converts this SecurityMessage to JSON.
     * @function toJSON
     * @memberof SecurityMessage
     * @instance
     * @returns {Object.<string,*>} JSON object
