...
export class SecurityMessage implements ISecurityMessage {

    /**
     * Constructs a new SecurityMessage.
     * @param [properties] Properties to set
     */
    constructor(properties?: ISecurityMessage);
     ...
     * @param [properties] Properties to set
     * @returns SecurityMessage instance
     */
    public static create(properties?: ISecurityMessage): SecurityMessage;

    /**
     * Encodes the specified SecurityMessage message. Does not implicitly {@link SecurityMessage.verify|verify} messages.
     * @param message SecurityMessage message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: ISecurityMessage, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: ISecurityMessage, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): SecurityMessage;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): SecurityMessage;
     ...
     * @returns SecurityMessage
     */
    public static fromObject(object: { [k: string]: any }): SecurityMessage;

    /**
     * Creates a plain object from a SecurityMessage message. Also converts values to other types if specified.
     * @param message SecurityMessage
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: SecurityMessage, options?: $protobuf.IConversionOptions): { [k: string]: any };
